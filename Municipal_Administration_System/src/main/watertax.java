...
class watertax extends JInternalFrame {
	...
	public watertax() {
		...
		l8 = new JLabel("Water         TAX          PAYMENT");
		...
		l3 = new JLabel("Tax Amount Per Unit (In Rupees)");
		l3.setBounds(70, 160, 250, 20);
		add(l3);
		...
		l4 = new JLabel("Total Amount To Be Paid (In Rupees)");
		...
		l5 = new JLabel("Unique House No");
		l5.setBounds(420, 80, 100, 20);
		add(l5);

		t5 = new JTextField();
		t5.setBounds(570, 80, 100, 20);
		add(t5);

		l6 = new JLabel("Unit Reading");
		l6.setBounds(420, 120, 100, 20);
		add(l6);

		t6 = new JTextField();
		t6.setBounds(570, 120, 100, 20);
		add(t6);
